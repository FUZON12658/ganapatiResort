...
const FloatingMenu = () => {
  ...
  return (
    ...
    <div className="hamburgerMenu z-50 top-0">
      ...
      <div className="flex flex-col mt-2 sm:flex-row items-center justify-center w-full h-full text-lg sm:gap-48 xl:text-xl xl:leading-10 2xl:text-2xl 2xl:leading-10" style={{fontFamily:"Lobster"}}>
